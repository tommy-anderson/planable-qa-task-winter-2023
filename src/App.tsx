...
function App() {
  ...
  const [selectedUnit, setSelectedUnit] = useState<"units" | "pounds" | "cups">(
    "units"
  );
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <button
              ...
              className={
                "hover:bg-blue-700 text-white font-bold py-2 px-4 ml-4 rounded focus:outline-none focus:shadow-outline" +
                (selectedItem.name ? " bg-blue-500" : " bg-gray-500")
              }
            >
              Save
            </button>
      ...
      <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div className="flex items-center mb-4">
          ...
          />
          <select
            data-cy="selectedUnit"
            value={selectedUnit}
            onChange={(e) =>
              setSelectedUnit(e.target.value as "units" | "pounds" | "cups")
            }
            className="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mr-4"
          >
            <option value="units">units</option>
          ...
          <button
            ...
            onClick={addItem}
            className={
              "text-white font-bold py-2 px-4 ml-4 rounded focus:outline-none focus:shadow-outline" +
              (newItem ? " bg-blue-500 hover:bg-blue-700 " : " bg-gray-500")
            }
          >
            Add
          </button>
        </div>
        <ul className="list-none space-y-2" cy-data="itemList">
            ...
            >
              <div className="flex items-center">
                <span
                  ...
                  data-cy={`item-${index + 1}-name`}
                >
                  {item.name}
                </span>
                <span
                  className="text-gray-500 text-sm ml-4"
                  data-cy={`item-${index + 1}-quantity`}
                >
              ...
              {!item.completed && (
                <button
                  ...
                  data-cy={`item-${index + 1}-editButton`}
                >
                  <svg
                    width="32px"
                    height="32px"
